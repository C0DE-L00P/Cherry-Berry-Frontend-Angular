...
export class ProductsService {
  ...
  GetProductByIDFromAPI(_id:string):Observable<IProduct>{
    return this.http.get<IProduct>(this._url+'/'+_id).pipe(catchError((err)=>{
      return throwError(()=>err.message || 'Server Error')
    }))
  }
  ...
  GetAllCategories():Observable<ICategory[]>{
    return this.http.get<ICategory[]>(this._categories_url).pipe(catchError((err)=>{
      return throwError(()=>err.message || 'Server Error')
    }))
  }
  GetCategoryByID(id:any):Observable<ICategory[]>{
    return this.http.get<ICategory[]>(this._categories_url+'/'+id).pipe(catchError((err)=>{
      return throwError(()=>err.message || 'Server Error')
    }))
  }
  ...
  PutCategoryByID(id:any,body:any):Observable<ICategory[]>{
    return this.http.put<ICategory[]>(this._categories_url+'/'+id,body).pipe(catchError((err)=>{
      return throwError(()=>err.message || 'Server Error')
    }))
  }
  PutReviewByID(id:any,body:any):Observable<IReview[]>{
    return this.http.put<IReview[]>(this._reviews_url+'/'+id,body).pipe(catchError((err)=>{
      return throwError(()=>err.message || 'Server Error')
    }))
  }
  ...
  DeleteCategoryByID(id:any):Observable<ICategory[]>{
    return this.http.delete<ICategory[]>(this._categories_url+'/'+id).pipe(catchError((err)=>{
      return throwError(()=>err.message || 'Server Error')
    }))
  }
  DeleteReviewByID(id:any):Observable<IReview[]>{
    return this.http.delete<IReview[]>(this._reviews_url+'/'+id).pipe(catchError((err)=>{
      return throwError(()=>err.message || 'Server Error')
    }))
  }
